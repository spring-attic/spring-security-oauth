...
public interface OAuthProviderSupport {
	...
	/**
	 * Parse the oauth consumer parameters from an HttpServletRequest.
	 * The parameters are to be decoded per the OAuth spec.
	 *
	 * @param request The servlet request.
	 * @return The parsed parameters.
	 */
	OAuthParameters parseParameters(HttpServletRequest request);
