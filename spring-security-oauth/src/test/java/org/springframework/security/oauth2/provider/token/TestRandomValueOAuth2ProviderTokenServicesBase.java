...
public abstract class TestRandomValueOAuth2ProviderTokenServicesBase extends TestCase {
  ...
  public void testStoreAccessToken() {
    ...
    OAuth2AccessToken actualOAuth2AccessToken = getRandomValueOAuth2ProviderTokenServices().readAccessToken("testToken");
    assertEquals(expectedOAuth2AccessToken, actualOAuth2AccessToken);
    assertEquals(expectedAuthentication, getRandomValueOAuth2ProviderTokenServices().readAuthentication(expectedOAuth2AccessToken));
  ...
  public void testStoreRefreshToken() {
    ...
    getRandomValueOAuth2ProviderTokenServices().storeRefreshToken(expectedExpiringRefreshToken, expectedAuthentication);

    ExpiringOAuth2RefreshToken actualExpiringRefreshToken = getRandomValueOAuth2ProviderTokenServices().readRefreshToken("testToken");
    assertEquals(expectedExpiringRefreshToken, actualExpiringRefreshToken);
    assertEquals(expectedAuthentication, getRandomValueOAuth2ProviderTokenServices().readAuthentication(expectedExpiringRefreshToken));
