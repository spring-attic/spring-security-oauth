...
class ClientDetailsServiceBeanDefinitionParserTests {

    @Autowired
    private ClientDetailsService clientDetailsService;

    @Test
    void testClientDetailsFromNonPropertyFile() {
    ...
    @Test
    void testClientDetailsFromPropertyFile() {
    ...
    @Test
    void testClientDetailsDefaultFlow() {
