...
class JwkDefinitionSourceTests {
    ...
    @Test
    void constructorWhenInvalidJwkSetUrlThenThrowIllegalArgumentException() throws Exception {
    ...
    @Test
    void constructorListWhenInvalidJwkSetUrlThenThrowIllegalArgumentException() throws Exception {
        assertThrows(IllegalArgumentException.class, () -> {
    ...
    // gh-1010
    @Test
    void getVerifierWhenModulusMostSignificantBitIs1ThenVerifierStillVerifyContentSignature() throws Exception {
