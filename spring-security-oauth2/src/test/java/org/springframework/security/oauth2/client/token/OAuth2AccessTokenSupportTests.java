...
class OAuth2AccessTokenSupportTests {
    ...
    @Test
    void testRetrieveTokenFailsWhenTokenEndpointNotAvailable() {
    ...
    @Test
    void testRetrieveToken() throws Exception {
    ...
    @Test
    void testRetrieveTokenFormEncoded() throws Exception {
    ...
    @Test
    void testRequestEnhanced() throws Exception {
    ...
    @Test
    void testRequestNotEnhanced() throws Exception {
        request.set("foo", "bar");
        response.setBody(objectMapper.writeValueAsString(accessToken));
        OAuth2AccessToken retrieveToken = support.retrieveToken(request, resource, form, requestHeaders);
