...
class TokenEndpointTests {
    ...
    private Principal clientAuthentication = new UsernamePasswordAuthenticationToken("client", null, Collections.singleton(new SimpleGrantedAuthority("ROLE_CLIENT")));

    private TokenRequest createFromParameters(Map<String, String> parameters) {
        TokenRequest request = new TokenRequest(parameters, parameters.get(OAuth2Utils.CLIENT_ID), OAuth2Utils.parseParameterList(parameters.get(OAuth2Utils.SCOPE)), parameters.get(OAuth2Utils.GRANT_TYPE));
        return request;
    }
    ...
    @Test
    void testGetAccessTokenWithNoClientId() throws HttpRequestMethodNotSupportedException {
    ...
    @Test
    void testGetAccessTokenWithScope() throws HttpRequestMethodNotSupportedException {
    ...
    @Test
    void testGetAccessTokenWithUnsupportedRequestParameters() throws HttpRequestMethodNotSupportedException {
    ...
    @Test
    void testImplicitGrant() throws HttpRequestMethodNotSupportedException {
    ...
    // gh-1268
    @Test
    void testGetAccessTokenReturnsHeaderContentTypeJson() throws Exception {
        when(clientDetailsService.loadClientByClientId(clientId)).thenReturn(clientDetails);
        HashMap<String, String> parameters = new HashMap<String, String>();
        parameters.put("client_id", clientId);
        parameters.put("scope", "read");
    ...
    @Test
    void testRefreshTokenGrantTypeWithoutRefreshTokenParameter() throws Exception {
    ...
    @Test
    void testGetAccessTokenWithRefreshToken() throws Exception {
        when(clientDetailsService.loadClientByClientId(clientId)).thenReturn(clientDetails);
        HashMap<String, String> parameters = new HashMap<String, String>();
        parameters.put("client_id", clientId);
        parameters.put("scope", "read");
