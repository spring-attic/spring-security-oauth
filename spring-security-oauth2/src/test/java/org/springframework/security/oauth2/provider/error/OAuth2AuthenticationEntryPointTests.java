...
class OAuth2AuthenticationEntryPointTests {
    ...
    @Test
    void testCommenceWithJson() throws Exception {
    ...
    @Test
    void testCommenceWithOAuth2Exception() throws Exception {
        request.addHeader("Accept", MediaType.APPLICATION_JSON_VALUE);
    ...
    @Test
    void testCommenceWithXml() throws Exception {
    ...
    @Test
    void testCommenceWithEmptyAccept() throws Exception {
        entryPoint.commence(request, response, new BadCredentialsException("Bad"));
        assertEquals(HttpServletResponse.SC_UNAUTHORIZED, response.getStatus());
        assertEquals("{\"error\":\"unauthorized\",\"error_description\":\"Bad\"}", response.getContentAsString());
    ...
    @Test
    void testCommenceWithHtmlAccept() throws Exception {
    ...
    @Test
    void testCommenceWithHtmlAndJsonAccept() throws Exception {
