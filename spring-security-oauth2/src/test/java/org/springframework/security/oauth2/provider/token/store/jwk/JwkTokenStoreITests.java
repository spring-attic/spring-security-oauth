...
class JwkTokenStoreITests {
    ...
    @Test
    void readAccessTokenWhenJwtHasValidIssuerClaimThenVerificationSucceeds() throws Exception {
    ...
    // gh-1114 Issuer claim verification
    @Test
    void readAccessTokenWhenJwtHasInvalidIssuerClaimThenVerificationFails() throws Exception {
