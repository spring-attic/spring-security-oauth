 ...
 * @author Dave Syer
 */
class TokenServicesWithTokenEnhancerTests {
    ...
    @Test
    void scopePreservedWhenTokenCreated() {
    ...
    @Test
    void additionalInfoPreservedWhenTokenDecoded() {
    ...
    // gh-511
    @Test
    void storeEnhancedRefreshTokenDuringRefresh() {
