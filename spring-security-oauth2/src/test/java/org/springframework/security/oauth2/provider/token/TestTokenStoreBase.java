...
public abstract class TestTokenStoreBase {
	...
	public void testStoreAccessToken() {
		OAuth2Authentication expectedAuthentication = new OAuth2Authentication(new StoredRequest(null, "id",
				null, false, null, null), new TestAuthentication("test2", false));
	...
	public void testRetrieveAccessToken() {
		...
		StoredRequest storedRequest = new StoredRequest(null, "id",	null, true, null, null);
		...
		storedRequest = new StoredRequest(null, "id", null, false, null, null);
	...
	public void testFindAccessTokensByUserName() {
		OAuth2Authentication expectedAuthentication = new OAuth2Authentication(new StoredRequest(null, "id", null, false, null, null), new TestAuthentication("test2", false));
		OAuth2AccessToken expectedOAuth2AccessToken = new DefaultOAuth2AccessToken("testToken");
		getTokenStore().storeAccessToken(expectedOAuth2AccessToken, expectedAuthentication);
