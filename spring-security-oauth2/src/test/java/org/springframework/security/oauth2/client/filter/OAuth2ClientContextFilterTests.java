...
class OAuth2ClientContextFilterTests {
    ...
    @Test
    void testVanillaRedirectUri() throws Exception {
    ...
    @Test
    void testTwoScopesRedirectUri() throws Exception {
        String redirect = "https://example.com/authorize";
        Map<String, String> params = new LinkedHashMap<String, String>();
        params.put("foo", "bar");
    ...
    @Test
    void testRedirectUriWithUrlInParams() throws Exception {
        String redirect = "https://example.com/authorize";
        Map<String, String> params = Collections.singletonMap("redirect", "https://foo/bar");
        testRedirectUri(redirect, params, redirect + "?redirect=https://foo/bar");
    }

    @Test
    void testRedirectUriWithQuery() throws Exception {
    ...
    @Test
    void testVanillaCurrentUri() throws Exception {
        OAuth2ClientContextFilter filter = new OAuth2ClientContextFilter();
        MockHttpServletRequest request = new MockHttpServletRequest();
    ...
    @Test
    void testCurrentUriWithLegalSpaces() throws Exception {
        OAuth2ClientContextFilter filter = new OAuth2ClientContextFilter();
        MockHttpServletRequest request = new MockHttpServletRequest();
    ...
    @Test
    void testCurrentUriWithNoQuery() throws Exception {
        OAuth2ClientContextFilter filter = new OAuth2ClientContextFilter();
        MockHttpServletRequest request = new MockHttpServletRequest();
    ...
    @Test
    void testCurrentUriWithIllegalSpaces() throws Exception {
        OAuth2ClientContextFilter filter = new OAuth2ClientContextFilter();
        MockHttpServletRequest request = new MockHttpServletRequest();
    ...
    @Test
    void testCurrentUriRemovingCode() throws Exception {
        OAuth2ClientContextFilter filter = new OAuth2ClientContextFilter();
        MockHttpServletRequest request = new MockHttpServletRequest();
    ...
    @Test
    void testCurrentUriRemovingCodeInSecond() throws Exception {
        OAuth2ClientContextFilter filter = new OAuth2ClientContextFilter();
        MockHttpServletRequest request = new MockHttpServletRequest();
    ...
    @Test
    void testCurrentUriWithInvalidQueryString() throws Exception {
        OAuth2ClientContextFilter filter = new OAuth2ClientContextFilter();
        MockHttpServletRequest request = new MockHttpServletRequest();
