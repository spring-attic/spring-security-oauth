...
/**
 * Base class for testing Jackson serialization and deserialization of {@link org.springframework.security.oauth2.common.OAuth2AccessToken}.
 *
 * @author Rob Winch
 */
@RunWith(PowerMockRunner.class)
@PrepareForTest({ System.class })
abstract class BaseOAuth2AccessTokenJackson2Test {
	...
	public BaseOAuth2AccessTokenJackson2Test() {
		super();
	}
