 ...
 */
class JdbcTokenStoreTests extends TokenStoreBaseTests {
    ...
    @Test
    void testAllowedCustomTokenWithCustomStrategy() {
    ...
    @Test
    void testNotAllowedCustomTokenWithCustomStrategy() {
    ...
    // gh-1907
    @Test
    void testGetAccessTokenWithInvalidStoredAuthentication() {
        OAuth2Authentication expectedAuthentication = new OAuth2Authentication(RequestTokenFactory.createOAuth2Request("id", false), new TestAuthentication("test2", false));
        OAuth2AccessToken expectedOAuth2AccessToken = new DefaultOAuth2AccessToken("testToken");
