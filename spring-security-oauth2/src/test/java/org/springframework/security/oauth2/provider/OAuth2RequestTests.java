...
class OAuth2RequestTests {
    ...
    @Test
    void testImplicitGrantType() throws Exception {
    ...
    @Test
    void testOtherGrantType() throws Exception {
    ...
    // gh-724
    @Test
    void testResourceIdsConstructorAssignment() {
    ...
    private OAuth2Request createFromParameters(Map<String, String> parameters) {
        OAuth2Request request = RequestTokenFactory.createOAuth2Request(parameters, parameters.get(OAuth2Utils.CLIENT_ID), false, OAuth2Utils.parseParameterList(parameters.get(OAuth2Utils.SCOPE)));
        return request;
    }

    // gh-812
    @Test
    void testRequestParametersReAssignmentWithSerialization() {
