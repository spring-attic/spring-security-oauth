...
public class OAuth2ClientAuthenticationProcessingFilter extends AbstractAuthenticationProcessingFilter {
	...
	public OAuth2ClientAuthenticationProcessingFilter(RequestMatcher requiresAuthenticationRequestMatcher) {
		...
		try {
			...
			if (authenticationDetailsSource!=null) {
				...
				if (accessToken.getRefreshToken() != null) {
					request.setAttribute(OAuth2AuthenticationDetails.REFRESH_TOKEN_VALUE, accessToken.getRefreshToken().getValue());
				}
