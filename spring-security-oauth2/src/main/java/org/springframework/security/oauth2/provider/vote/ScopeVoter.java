 ...
 * {@link OAuth2Request} (which contains teh scope data). Votes to grant access if there is an exact matching
 * {@link OAuth2Request#getScope() authorized scope} to a <code>ConfigAttribute</code> starting with the scope
