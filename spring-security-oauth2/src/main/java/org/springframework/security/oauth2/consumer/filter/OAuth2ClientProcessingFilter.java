...
public class OAuth2ClientProcessingFilter implements Filter, InitializingBean, MessageSourceAware {
  ...
  /**
   * Loads the resource dependencies for the given request. This will be a set of {@link org.springframework.security.oauth2.consumer.OAuth2ProtectedResourceDetails#getId() resource ids}
